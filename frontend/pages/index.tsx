...
export default function Home({ events }: PostDataResponse) {
   return (
      <Layout currentPage="Home">
         <Hero />
         <div className="grid sm:grid-cols-2 gap-0 w-screen sm:w-full">
            <div className="w-full flex flex-col items-center justify-center bg-gray-200 dark:bg-gray-200 text-white">
               <AboutUs />
            </div>
