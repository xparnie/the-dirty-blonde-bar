...
const Hero: React.FC = () => (
   <div className="flex flex-col items-center justify-center p-4 h-[calc(100vh_-_90px)] max-h-[845px] sm:min-h-[845px] sm:h-full bg-cover bg-center bg-[url('/assets/bwbar.jpg')]">
